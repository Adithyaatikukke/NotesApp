...
const PNotesArea = ({ selected, setSelected, notes, setNotes }) => {
	...
	return (
		<div className="p_notes_area">
			<div className="p_notes_content_title">
			<img src={back} alt="back" onClick={Homee} />	
				<div
					className="p_notes_content_title_color"
					style={{ backgroundColor: bgColor }}
				>
					{initials}
				</div>
				<div className="p_notes_content_title_text">{selectedTitle}</div>
			</div>
			<div className="p_notes_area_body">
				{notes.length === 0 ? (
					<div
						className="p_notes_area_body_empty"
